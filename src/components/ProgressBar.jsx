    ...
    <div className="w-full">
      {label && (
        <div className="flex justify-between items-center mb-1">
          <span className="font-display text-xs font-bold text-gray-600">{label}</span>
          <span className="font-display text-xs font-bold text-gray-400">{Math.round(percentage)}%</span>
        </div>
      )}
