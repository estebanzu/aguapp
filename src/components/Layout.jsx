...
const navItems = [
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="w-7 h-7">
        <text x="4" y="18" fontSize="16" fontWeight="bold" fill="currentColor" stroke="none">1</text>
        <text x="14" y="18" fontSize="16" fontWeight="bold" fill="currentColor" stroke="none">2</text>
      </svg>
    ),
  },
  {
