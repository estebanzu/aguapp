      ...
      <>
        ...
        <div className="px-6 py-8">
          <div className="flex flex-col items-center justify-center gap-6 py-12 animate-bounce-in">
            ...
            <button
              onClick={restart}
              className="mt-4 px-8 py-4 bg-blue-500 text-white font-display font-bold text-lg rounded-2xl hover:bg-blue-600 active:scale-95 transition-all shadow-lg shadow-blue-200"
            >
              🔁 Rejouer
            </button>
          </div>
